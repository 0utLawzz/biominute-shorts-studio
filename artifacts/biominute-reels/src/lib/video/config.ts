...
// Hook: ep66 — "Does Skipping Breakfast Slow Your Metabolism?"
export const SCENE_DURATIONS = {
  0: 4500, // Scene 0 — Hook
  1: 7000, // Scene 1 — The Breakfast Myth
  2: 7000, // Scene 2 — What Actually Matters
  3: 6500, // Scene 3 — The Bottom Line
  4: 7000, // Scene 4 — CTA
  5: 5000, // Scene 5 (unused for ep66)
} as const;
