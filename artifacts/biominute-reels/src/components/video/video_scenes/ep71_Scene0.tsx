...
import { Flame, HeartPulse, Footprints } from 'lucide-react';
...
export function Scene0() {
  ...
  return (
    <motion.div className="absolute inset-0 w-full h-full bg-[#0F172A] flex flex-col items-center justify-center overflow-hidden font-body"
      ...
      <motion.div className="absolute top-[10%] w-[500px] h-[500px] bg-gradient-to-tr from-[#2F6FED]/15 to-[#f97316]/10 rounded-full blur-[130px]"
      ...
      <div className="absolute top-[185px] flex flex-col items-center gap-6 z-10 w-full px-12">
        <motion.div className="relative w-[220px] h-[220px]"
          ...
          <motion.div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            <div className="relative">
              ...
              <Flame size={96} color="#2F6FED" strokeWidth={1.3} />
            </div>
          </motion.div>
        ...
        <motion.div className="flex items-center gap-3 bg-[#2F6FED]/10 border border-[#2F6FED]/30 px-7 py-4 rounded-2xl"
          ...
          <HeartPulse size={20} color="#2F6FED" />
          <span className="text-[#2F6FED] font-display font-bold text-[18px] uppercase tracking-wider">S2 • Movement &amp; Body</span>
        </motion.div>
      </div>
