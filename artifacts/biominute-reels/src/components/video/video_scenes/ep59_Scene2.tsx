    ...
    <motion.div className="absolute inset-0 w-full h-full bg-[#0F172A] flex flex-col items-center justify-center overflow-hidden font-body"
      ...
      <div className="absolute top-[150px] flex flex-col items-center gap-5 z-10 w-full px-10">
        <motion.div className="bg-[#f97316]/10 border border-[#f97316]/30 px-8 py-4 rounded-2xl"
          ...
          <span className="text-[#f97316] font-display font-bold text-[22px] uppercase tracking-wider">Why It Pops</span>
        </motion.div>
        {[
          { icon: Droplets, color: '#2F6FED', label: 'Synovial fluid under pressure', body: 'Joints contain fluid — pulling them apart creates a low-pressure space instantly' },
          { icon: Zap, color: '#f97316', label: 'Gas cavitation causes the crack', body: 'Dissolved gases form a bubble that collapses with that characteristic pop sound' },
          { icon: Activity, color: '#10b981', label: 'Joint reforms within minutes', body: 'The gas re-dissolves in about 20 minutes — that\'s why you can\'t crack it again right away' },
        ].map((item, i) => {
