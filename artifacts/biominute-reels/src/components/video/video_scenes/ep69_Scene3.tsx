    ...
    <motion.div className="absolute inset-0 w-full h-full bg-[#0F172A] flex flex-col items-center justify-center overflow-hidden font-body"
      ...
      <div className="absolute top-[150px] flex flex-col items-center gap-5 z-10 w-full px-10">
        <motion.div className="bg-[#10b981]/10 border border-[#10b981]/30 px-8 py-4 rounded-2xl"
          ...
          <span className="text-[#10b981] font-display font-bold text-[22px] uppercase tracking-wider">Best Use of Cold Showers</span>
        </motion.div>
        {[
          { icon: Zap, color: '#10b981', label: 'Alertness is the real win', body: 'The noradrenaline spike from cold water is a genuine, lasting wake-up jolt — better than snoozing' },
          { icon: ShieldCheck, color: '#f97316', label: 'Mood and resilience benefits', body: 'Regular cold exposure is linked to reduced anxiety and improved mental toughness over time' },
          { icon: Droplets, color: '#10b981', label: 'Think wake-up tool, not hack', body: 'Cold showers work best as a morning ritual for alertness and mood — not a metabolism shortcut' },
        ].map((item, i) => {
