...
import { Calendar, Dna, Utensils, Dumbbell } from 'lucide-react';
...
export function Scene2() {
  ...
  const factors = [
    { Icon: Calendar, label: 'Years', color: '#10b981', delay: 0.2, angle: 0 },
    { Icon: Dna, label: 'Genetics', color: '#2F6FED', delay: 0.5, angle: 120 },
    { Icon: Utensils, label: 'Nutrition', color: '#f97316', delay: 0.8, angle: 240 },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[240px] flex flex-col items-center z-10 w-full">
        ...
        >
          <span className="text-[#f8fafc] font-display font-bold text-[22px] uppercase tracking-wider">Large Muscle Takes Dedicated Time</span>
        </motion.div>
      </div>
