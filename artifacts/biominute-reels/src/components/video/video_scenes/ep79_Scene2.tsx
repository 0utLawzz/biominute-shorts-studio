...
import { ThermometerSnowflake, AlertTriangle, Moon } from 'lucide-react';
    ...
    <motion.div className="absolute inset-0 w-full h-full bg-[#0F172A] flex flex-col items-center justify-center overflow-hidden font-body"
      ...
      <div className="absolute top-[150px] flex flex-col items-center gap-5 z-10 w-full px-10">
        <motion.div className="bg-[#f97316]/10 border border-[#f97316]/30 px-8 py-4 rounded-2xl"
          ...
          <span className="text-[#f97316] font-display font-bold text-[22px] uppercase tracking-wider">Too Warm Can Slow Sleep</span>
        </motion.div>
        {[
          { icon: ThermometerSnowflake, color: '#2F6FED', title: '65–68°F is often cited', body: 'A cool bedroom in this range can help your body reach sleep-friendly temperature more easily' },
          { icon: AlertTriangle, color: '#f97316', title: 'Warmth can delay sleep onset', body: 'If you feel hot and stuffy, your body may struggle to settle down for the night' },
          { icon: Moon, color: '#2F6FED', title: 'Comfort matters', body: 'The best temperature is the one that feels cool, calm, and easy to stay asleep in' },
        ].map((item, i) => {
