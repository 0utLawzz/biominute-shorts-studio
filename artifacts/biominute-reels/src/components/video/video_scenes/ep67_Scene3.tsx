...
import { ShieldCheck, Scale, Coffee } from 'lucide-react';
    ...
    <motion.div className="absolute inset-0 w-full h-full bg-[#0F172A] flex flex-col items-center justify-center overflow-hidden font-body"
      ...
      <div className="absolute top-[150px] flex flex-col items-center gap-5 z-10 w-full px-10">
        <motion.div className="bg-[#f97316]/10 border border-[#f97316]/30 px-8 py-4 rounded-2xl"
          ...
          <span className="text-[#f97316] font-display font-bold text-[22px] uppercase tracking-wider">The Smart Call</span>
        </motion.div>
        {[
          { icon: ShieldCheck, color: '#10b981', label: 'Both options are valid', body: 'If you enjoy black coffee, great. If you prefer milk, the core benefits remain intact' },
          { icon: Scale, color: '#f97316', label: 'Calories decide the winner', body: 'For weight or blood sugar goals, keep add-ins minimal — that\'s the only real trade-off' },
          { icon: Coffee, color: '#10b981', label: 'Drink what you\'ll stick to', body: 'Consistency matters more than optimisation — enjoy your coffee the way you like it' },
        ].map((item, i) => {
