    ...
    <motion.div className="absolute inset-0 w-full h-full bg-[#0F172A] flex flex-col items-center justify-center overflow-hidden font-body"
      ...
      <div className="absolute top-[150px] flex flex-col items-center gap-5 z-10 w-full px-10">
        <motion.div className="bg-[#10b981]/10 border border-[#10b981]/30 px-8 py-4 rounded-2xl"
          ...
          <span className="text-[#10b981] font-display font-bold text-[22px] uppercase tracking-wider">How to Judge It</span>
        </motion.div>
        {[
          { icon: Footprints, color: '#10b981', label: 'Look at effort and duration', body: 'A workout that feels challenging and lasts long enough can be effective even without visible sweat' },
          { icon: Activity, color: '#2F6FED', label: 'Track progress over time', body: 'More reps, faster pace, or better technique are better markers than a wet shirt' },
          { icon: ShieldCheck, color: '#f97316', label: 'Sweat is not the goal', body: 'A cooler day, strong fan, or good fitness can all reduce sweat while the workout still counts' },
        ].map((item, i) => {
