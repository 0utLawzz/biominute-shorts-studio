    ...
    <motion.div className="absolute inset-0 w-full h-full bg-[#0F172A] flex flex-col items-center justify-center overflow-hidden font-body"
      ...
      <div className="absolute top-[150px] flex flex-col items-center gap-5 z-10 w-full px-10">
        <motion.div className="bg-[#f97316]/10 border border-[#f97316]/30 px-8 py-4 rounded-2xl"
          ...
          <span className="text-[#f97316] font-display font-bold text-[22px] uppercase tracking-wider">Intensity Matters</span>
        </motion.div>
        {[
          { icon: Timer, color: '#2F6FED', label: 'Short workouts: fine fasted', body: 'Under ~60 minutes at moderate intensity, most people do well without food' },
          { icon: Gauge, color: '#f97316', label: 'Long or hard sessions: fuel helps', body: 'Energy, endurance, and power tend to dip without pre-workout fuel for harder efforts' },
          { icon: Zap, color: '#10b981', label: 'Performance is the guide', body: 'If you feel sluggish, a small snack before training usually fixes it' },
        ].map((item, i) => {
