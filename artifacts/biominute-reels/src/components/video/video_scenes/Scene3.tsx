...
import { Dumbbell, Bone, Activity } from 'lucide-react';
...
export function Scene3() {
  ...
  const benefits = [
    { Icon: Dumbbell, label: 'Strength', color: '#10b981', delay: 0.2, angle: 0 },
    { Icon: Bone, label: 'Bone Health', color: '#2F6FED', delay: 0.5, angle: 120 },
    { Icon: Activity, label: 'Body Comp', color: '#f97316', delay: 0.8, angle: 240 },
  ];
    ...
    >
      ...
      <div className="absolute top-[240px] flex flex-col items-center z-10 w-full">
        <div className="relative w-[340px] h-[340px] flex items-center justify-center">
          ...
          {benefits.map(({ Icon, label, color, delay, angle }) => {
          ...
          >
            <Activity size={48} color="#0F172A" strokeWidth={2} />
          </motion.div>
        </div>
        ...
        >
          <span className="text-[#f8fafc] font-display font-bold text-[22px] uppercase tracking-wider">The Real Benefits of Lifting</span>
        </motion.div>
      </div>
      ...
      >
        ...
        >
          For Most Women, Lifting Improves
          <motion.span
          ...
          >
            Strength, Bones & Body Composition
          </motion.span>
        </motion.h2>
      </div>
    </motion.div>
