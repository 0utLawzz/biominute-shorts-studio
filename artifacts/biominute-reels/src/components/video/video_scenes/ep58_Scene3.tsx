...
import { ShieldCheck, Apple, Clock } from 'lucide-react';
    ...
    <motion.div className="absolute inset-0 w-full h-full bg-[#0F172A] flex flex-col items-center justify-center overflow-hidden font-body"
      ...
      <div className="absolute top-[150px] flex flex-col items-center gap-5 z-10 w-full px-10">
        <motion.div className="bg-[#10b981]/10 border border-[#10b981]/30 px-8 py-4 rounded-2xl"
          ...
          <span className="text-[#10b981] font-display font-bold text-[22px] uppercase tracking-wider">What Helps</span>
        </motion.div>
        {[
          { icon: Clock, color: '#10b981', label: 'Slow down at meals', body: 'Chewing thoroughly and eating slowly drastically cuts swallowed air and gas' },
          { icon: Apple, color: '#2F6FED', label: 'Add fibre gradually', body: 'Increase fibre over 2–3 weeks so your gut bacteria can adapt without discomfort' },
          { icon: ShieldCheck, color: '#f97316', label: 'Don\'t cut entire food groups', body: 'Slowing pace often fixes bloating better than eliminating foods unnecessarily' },
        ].map((item, i) => {
