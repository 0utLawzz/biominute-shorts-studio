    ...
    <motion.div className="absolute inset-0 w-full h-full bg-[#0F172A] flex flex-col items-center justify-center overflow-hidden font-body"
      ...
      <div className="absolute top-[160px] flex flex-col items-center gap-5 z-10 w-full px-10">
        <motion.div className="bg-[#10b981]/10 border border-[#10b981]/30 px-8 py-4 rounded-2xl"
          ...
          <span className="text-[#10b981] font-display font-bold text-[22px] uppercase tracking-wider">What Cold Does</span>
        </motion.div>
        {[
          { icon: Thermometer, color: '#10b981', title: 'Brown fat activates', body: 'Cold triggers brown adipose tissue to generate heat by burning stored fat — the thermogenesis effect' },
          { icon: Flame, color: '#f97316', title: 'Calorie burn ticks up briefly', body: 'Your body works harder to maintain core temperature, briefly elevating calorie expenditure' },
          { icon: Activity, color: '#10b981', title: 'The effect is real', body: 'Research confirms a measurable metabolic response to cold exposure — it isn\'t placebo' },
        ].map((item, i) => {
